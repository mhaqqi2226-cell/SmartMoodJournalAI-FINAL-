...
async function askAI() {
    ...
    try {
        ...
        await API.saveChatHistory(chatHistory);
        renderChatHistory();
    } catch (error) {
        chatHistory.push({
            role: 'assistant',
            content: '❌ Terjadi kesalahan. Pastikan server berjalan dan API key sudah diatur dengan benar.'
        });
        renderChatHistory();
    } finally {
        // Re-enable button
